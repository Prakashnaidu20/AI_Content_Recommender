...
Processing (NLP), similarity-based machine learning models, and LLM-style reasoning.

The project is primarily implemented and evaluated inside a Jupyter Notebook for
...
- Simulate LLM-style reasoning without external APIs
